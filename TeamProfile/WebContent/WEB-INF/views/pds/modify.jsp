								...
								<div class="card card-outline card-success">
									...
									<div class="card-footer fileInput">
										<ul class="mailbox-attachments d-flex align-items-stretch clearfix">
											...
											<li class="attach-item thumb${pfile.p_ano }" file-name="${pfile.filename }" target-ano="${pfile.p_ano }">																			
												<div class="mailbox-attachment-info ">
													<a class="mailbox-attachment-name" name="attachedFile" attach-fileName="${pfile.filename }" attach-no="${pfile.p_ano }" href="<%=request.getContextPath()%>/pds/getFile.do?ano=${pfile.p_ano }"  >													
														<i class="fas fa-paperclip"></i>
														${pfile.filename }&nbsp;&nbsp;
														<button type="button" onclick="removeFile_go('thumb${pfile.p_ano}');return false;" style="border:0;outline:0;" 

				...
				<div class="card card-outline card-info">
					...
					<div class="card-body pad">
						<form action="modify.do" method="post" role="modifyForm">
							<label for="fix"><input type="checkbox" id="fix" name="fix" value="" ${notice.fix eq '1'? 'checked':'' }>&nbsp;&nbsp;상단고정</label>
							<input type="hidden" name="nno" value="${notice.nno }" />
							<div class="form-group">
								<label for="title">제 목</label> 
								<input 
								
								type="text" id="title" value="${notice.title }"
							...
							<div class="form-group">
								...
								<input type="date" id="endDate" 
									name="endDate" class="form-control" value="">
							</div>
							<div class="form-group">
